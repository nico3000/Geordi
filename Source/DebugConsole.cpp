...
{
    static std::streambuf* g_pCinBuf  = NULL;
    static std::streambuf* g_pCoutBuf = NULL;
    static std::streambuf* g_pCerrBuf = NULL;
    static std::ifstream   g_consoleCin;
    static std::ofstream   g_consoleCout;
    static std::ofstream   g_consoleCerr;
